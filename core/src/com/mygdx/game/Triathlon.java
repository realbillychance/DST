...
{	
	...
	public Triathlon(FileHandle swimPivots, FileHandle runPivots, FileHandle cyclePivots, double swimSpeed, double cycleSpeed, double runSpeed, double transition1, double transition2)
	{
