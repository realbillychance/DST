...
{	
	...
	final static String KEY = "AIzaSyDNnPw5xXp5VwgAjatiQz93ux5crC3GOk0"; //Google Static Maps API Key
	
	public UrlBuilder(ArrayList<Double> lats, ArrayList<Double> longs)
	{
		this.lats = lats;
		this.longs = longs;
	}
    ...
    public String buildUrl() //creates the URL for the map
    {
    	...
    	imageUrl += "&markers=color:blue%7C" + lats.get(0) + "," + longs.get(0); //adds a marker at the start
